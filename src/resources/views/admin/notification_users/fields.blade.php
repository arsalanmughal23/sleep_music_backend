...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('notification_id', null, ['class' => 'form-control', 'placeholder'=>'Enter notification_id']) !!}
</div>
...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('admin.notification-users.index') !!}" class="btn btn-default">Cancel</a>
</div>