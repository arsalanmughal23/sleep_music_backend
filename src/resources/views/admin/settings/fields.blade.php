...
<div class="box col-sm-12">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        <!-- Generating Mix Sound Length Field -->
        <div class="form-group col-sm-6">
            {!! Form::label('mix_sound_length', 'Mix Sound Length:') !!}
            {!! Form::number('mix_sound_length', null, ['class' => 'form-control', 'min' => config('constants.min_mixer_audio_length'), 'max' => config('constants.max_mixer_audio_length')]) !!}
        </div>
        ...
        <div class="form-group col-sm-6 hide">
            ...
            {!! Form::number('commission', null, ['class' => 'form-control', 'step' => 0.01]) !!}
        </div>
        <div id="product-div">
