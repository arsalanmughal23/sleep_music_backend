...
class SettingRepository extends BaseRepository
{
    ...
    {
        $input = $request->only(['mix_sound_length', 'socialName', 'socialLink', 'logo', 'default_locale', 'email', 'phone', 'latitude', 'longitude', 'playstore', 'appstore', 'social_links', 'force_update', 'app_version', 'commission']);
